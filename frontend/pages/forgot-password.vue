<template>
    <div class="min-h-screen flex flex-col justify-center px-6 py-12 sm:px-12 lg:px-16 bg-white">
      <!-- Logo / Brand -->
      <div class="mb-8 text-center">
        <img class="h-10 w-auto mx-auto" src="https://via.placeholder.com/150x40?text=Logo" alt="Brand Logo" />
      </div>
  
      <!-- Title & Subtitle -->
      <h2 class="text-3xl font-bold text-gray-800 text-center">Forgot Your Password?</h2>
      ...
      <form class="space-y-6" @submit.prevent="handlePasswordReset">
        ...
        <div>
          ...
          <input
            ...
            autocomplete="email"
            required
            class="block w-full rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400
  ...
  export default {
    ...
    methods: {
      handlePasswordReset() {
        // Simulated password reset request logic
